                        ...
                        <div class="card-content">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="menus">
                                        <textarea name="menu" rows="10" cols="40">Escribe aquÃ­ tus comentarios</textarea>
                                    </div>
                            ...
                            <div class="row">
                            	...
                            	<div class = "col-sm-6">
			                        ...
			                        <div class="row form-group">
		                                ...
		                                <div class="col-sm-3">
		                                    <label for="numero"><strong>NÃ‚Âº</strong></label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="menus">
                                        <textarea name="descripcion">Escribe aquÃ­ tus comentarios</textarea>
                                    </div>
                                </div>
                            </div>
